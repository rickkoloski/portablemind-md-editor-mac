...
| D12 | Per-cell table editing — single-click caret in cell (primary); double-click drops to whole-table source (secondary). Fixes D8.1 caret position + size. | ✅ Complete — 2026-04-25 |
