...
| D15 | Scroll-jump-on-typing fix — `renderCurrentText` save+restore scrollY around the full-storage re-attribute. CD-discovered during D13 manual testing. | ✅ Complete — 2026-04-26 |
