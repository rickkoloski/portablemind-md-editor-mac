...
| D12 | Per-cell table editing — single-click caret in cell (primary); double-click / menu command drops to whole-table source (secondary). Fixes D8.1 caret position + size. | 📝 Triad drafted — 2026-04-24 |
